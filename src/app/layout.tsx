  ...
  return (
    <ConfigProvider theme={theme}>
      <html lang="en">
        ...
        <body
          className={`${Barlow.variable} ${Almarai.variable} antialiased max-w-[1440px] mx-auto px-1
          md:px-8 bg-neutrals-black text-neutrals-white relative scroll-smooth overflow-x-hidden`}
        >
          <AntdRegistry>
            <NavBar />
            {children}
